...
//            File mdDest = new File(applicationConfig.getPhotoDirectory() + File.separator + registeredPhoto.getId() + ".json");
...
//        }
//        File photoDest = new File(applicationConfig.getPhotoDirectory() + File.separator + registeredPhoto.getId() + photoExt);
