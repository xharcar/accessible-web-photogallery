...
public interface AlbumService {
     ...
     * @param photoBase64Id Base-64 identifier of the too-be-added photo
     ...
     * @param photoBase64Id Base-64 identifier of the to-be-removed photo
     ...
     * @return Optional containing an AlbumEntity whose base64Id equals base64 if such is found, an empty Optional otherwise
     */
