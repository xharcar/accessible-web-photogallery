...
public class PhotoDaoTest {
    ...
    @Test
    public void rejectTooLongIdTest() {
        PhotoEntity photo = createPhoto(userDao.findAll().get(0), Instant.now());
        photo.setId("thisIdistoolong");
        assertThrows(DataAccessException.class, () -> {
            photoDao.save(photo);
        });
    }
    ...
    public void findByIdTest() {
        ...
        photo = photoDao.save(photo);
        photoDao.save(photo2);
        Optional<PhotoEntity> found = photoDao.findById("thisisab64id");
    ...
    public void updatePhotoTest() {
        ...
        photo = photoDao.save(photo);
        Optional<PhotoEntity> found = photoDao.findById(photo.getId());
        assertTrue(found.isPresent());
